...
# Agent for scraped organigram information

class OrganigramAgent(BaseAgent):
    def __init__(self):
        # TODO: Exchange the dummy parts
        with open('data/dummy_data.txt', 'r', encoding='utf-8') as f:
            self.data = f.read()
    
        #self.index = faiss.read_index('data/organigram.faiss')
        #with open('data/organigram_docs.txt', 'r', encoding='utf-8') as f:
