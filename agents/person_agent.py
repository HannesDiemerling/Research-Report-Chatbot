...
# Agent for scraped mpib persons website information
...
class PersonnelAgent(BaseAgent):
    def __init__(self):
        ...
        #self.index = faiss.read_index('data/personnel.faiss')
        #with open('data/personnel_docs.txt', 'r', encoding='utf-8') as f:
